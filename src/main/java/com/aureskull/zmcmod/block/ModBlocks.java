...
public class ModBlocks {
    ...
    public static final Block MEDIUM_ZOMBIE_WINDOW = registerBlock("medium_zombie_window",
            new MediumZombieWindowBlock(FabricBlockSettings.copyOf(Blocks.NETHERITE_BLOCK).nonOpaque()));
